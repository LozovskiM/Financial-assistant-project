...
var Register = function () {
    ...
    var _d = react_1.useState(''), county = _d[0], setCountry = _d[1];
    ...
    return (React.createElement("form", { onSubmit: submit },
        ...
        React.createElement("input", { className: "form-control", placeholder: "Country", required: true, onChange: function (e) { return setCountry(e.target.value); } }),
